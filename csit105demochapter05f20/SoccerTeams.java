 ...
 * create from the number of available players - Input validation is
 * demonstrated with while loops.
 *
 * @author Tony Gaddis
 */
public class SoccerTeams {
    ...
    public static void main(String[] args) {
        ...
        while (teamSize < MIN_PLAYERS || teamSize > MAX_PLAYERS) {
            System.out.println("\nError!  You should have at least "
                    + MIN_PLAYERS
                    + " but no more than "
        ...
        System.out.print("\nEnter the available number of players: ");
        players = keyboard.nextInt();

        // Validate the input.
        while (players < 0) {
            System.out.println("\nError!  Please do not enter a negative "
                    + "number.");
