...
public class CompSciStudent extends Student {
    ...
    /**
     * The Constructor accepts as arguments the student's name, ID number, and
     * the year admitted.
     */
    ...
    /**
     * The setMathHours method accepts a value for the number of math hours
     * taken.
     */
    ...
    /**
     * The setCsHours method accepts a value for the number of computer science
     * hours taken.
     */
    ...
    /**
     * The setGenEdHours method accepts a value for the number of general
     * education hours taken.
     */
    ...
    /**
     * The getRemainingHours method returns the the number of hours remaining to
     * be taken.
     */
