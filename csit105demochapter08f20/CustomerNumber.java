...
/**
 * This program tests a customer number to determine whether it is in the proper
 * format.
 *
...
public class CustomerNumber {
    ...
    /**
     * The isValid method accepts a String as its argument and tests its
     * contents for a valid customer number.
     */
